...
CE = np.array(CE)
CE = pd.DataFrame(CE)
CE.columns = ['ID', 'month', 'CEts_tree','CEts_grass', 'CEts_cropland', 'r']
CE.to_csv(r'D:\Projects\Postdoc urban greening\Data\Cooling_Efficiency\CE_2020_monthly_Ts_v4.csv', index=False)
