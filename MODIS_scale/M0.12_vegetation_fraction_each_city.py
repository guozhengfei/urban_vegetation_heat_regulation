...
for i in cities_ID[1:]:
    ...
    ce = [ce_tree, ce_grass, ce_crop]
    CE.append([i] + ce)
    print(i)

CE = np.array(CE)
CE = pd.DataFrame(CE)
CE.columns = ['ID', 'FVC_tree', 'FVC_grass', 'FVC_cropland']
CE.to_csv(r'D:\Projects\Postdoc urban greening\Data\Cooling_Efficiency\FVC_2020_yearly_v4.csv', index=False)
