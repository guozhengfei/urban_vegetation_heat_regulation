...
TairMaxTiff_folder = r'D:\Projects\Postdoc urban greening\Data\ET_all\\'
...
CE = np.array(CE)
CE = pd.DataFrame(CE)
CE.columns = ['ID', 'ET_tree', 'ET_grass', 'ET_cropland','ET_r']
CE.to_csv(r'D:\Projects\Postdoc urban greening\Data\Cooling_Efficiency\ET_2020_yearly_v4.1.csv', index=False)
