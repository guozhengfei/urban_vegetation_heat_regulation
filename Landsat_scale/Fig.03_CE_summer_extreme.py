...
CETs = pd.read_csv(r'D:\Projects\Postdoc urban greening\Data\Cooling_Efficiency\CE_Landsat_yearly_Ts_summer_extreme.csv')
...
figToPath = r'D:\Projects\Postdoc urban greening\Figures_main\Fig03b_CE_by_koppen_landsat_summer_extreme_ts'
# fig.tight_layout()
...
ax.set_axis_off()
figToPath = r'D:\Projects\Postdoc urban greening\Figures_main\Fig03b_CE_by_koppen_landsat_summer_extreme_dt'
# fig.tight_layout()
fig.savefig(figToPath, dpi=600)
plt.close(fig)
