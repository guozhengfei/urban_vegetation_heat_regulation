...
CE = np.array(CE)
CE = pd.DataFrame(CE)
CE.columns = ['ID', 'alb_tree','alb_grass', 'alb_cropland', 'alb_build', 'r']
CE.to_csv(r'D:\Projects\Postdoc urban greening\Data\Cooling_Efficiency\Alb_Landsat_yearly_v1.csv', index=False)
