...
G_bu = Rn*df['ts_build_lds']*(0.0038+0.0074*alb)*(1-0.98*df['ndvi_build'].values**4) # method 3
#
...
ax.set_ylim([-4.5,3])
figToPath = current_dir + '/4_Figures/FigS_G_sensitivity_tree_method3'
fig.tight_layout()
fig.savefig(figToPath, dpi=600)
# plt.close(fig)
#