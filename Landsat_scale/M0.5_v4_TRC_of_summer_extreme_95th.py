...
TairMaxTiff_folder_extrem = current_dir + '/1_Input/LST_extreme/95th/'
...
CE.to_csv(current_dir + '/2_Output/Cooling_Efficiency/CE_Landsat_yearly_Ts_summer_extreme_95th.csv', index=False)
