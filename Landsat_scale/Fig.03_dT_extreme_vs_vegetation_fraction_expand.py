...
names = ['80th', '85th', '90th']
for name in names:
    CE_3d_v2 = np.load(current_dir + '/2_Output/Cooling_Efficiency/dT_vegetation_fraction_extreme_expand_'+name+'.npy')
    ...
    figToPath = current_dir + '/4_Figures/FigS03b_dT_vegetationfracion_landsat_extreme_expand_'+name
    fig.tight_layout()
    ...
    figToPath = current_dir + '/4_Figures/FigS03b_dT_vegetationfracion_hist_landsat_extreme_expand_'+name
    fig.savefig(figToPath, dpi=600)